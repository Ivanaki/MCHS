...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean FlashlightRight
        {
            get
            {
                return SteamVR_Actions.default_FlashlightRight;
            }
        }
        
        public virtual SteamVR_Action_Boolean FlashlightLeft
        {
            get
            {
                return SteamVR_Actions.default_FlashlightLeft;
            }
        }
